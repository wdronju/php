    ...
    <div class="user-container">
        ...
        <table class="user-table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM user ORDER BY user_id ASC LIMIT 3 OFFSET $offset";
    ...
    ?>
        ...
        <div class="pagination">
            ...
            if($pageDecreement == 0){
                ...
                echo "<a class='page-number active' href='testpagination.php?page=$pageDecreement'>Prev</a>";
            }
        ...
        if($pageIncreement > $dividatd){
            ...
            echo    "<a class='page-number active' href='testpagination.php?page=$pageIncreement'>Next</a>";
        }
